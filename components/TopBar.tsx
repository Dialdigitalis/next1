      ...
      <div className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 shadow-sm">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-3">
            <img src="hubric.png" alt="Logo" className="w-10 h-10 rounded-lg" />
            <div>
              <h1 className="text-sm font-semibold text-gray-800">
                {currentProject?.title || 'Hubric'}
              </h1>
                  ...
                  <div className="max-h-80 overflow-y-auto">
                    {networks.map((network) => (
                      <button
                        ...
                        className={`w-full px-4 py-3 text-left hover:bg-gray-50 transition-colors flex items-center justify-between ${selectedNetwork?.id === network.id ? 'bg-secondary bg-opacity-10' : ''
                          }`}
                      >
                        <div>
