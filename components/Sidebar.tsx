  ...
  return (
    ...
    >
      ...
      <div className="p-4 border-b border-gray-200 flex items-center justify-between">
        <h2 className="font-semibold text-gray-800"> Hubric Workflow Library</h2>
        <button
          type="button"
      ...
      <div className="flex border-b border-gray-200">
        <button
          ...
          className={`flex-1 py-3 px-4 font-medium text-sm transition-colors ${activeTab === 'nodes'
        ...
        <button
          ...
          className={`flex-1 py-3 px-4 font-medium text-sm transition-colors ${activeTab === 'templates'
              ? 'text-primary border-b-2 border-primary'
              : 'text-gray-600 hover:text-gray-800'
            }`}
        >
